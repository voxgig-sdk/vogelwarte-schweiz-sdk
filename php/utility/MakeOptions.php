...
// VogelwarteSchweiz SDK utility: make_options

class VogelwarteSchweizMakeOptions
{
    ...
    public static function call(VogelwarteSchweizContext $ctx): array
    {
        ...
        //
        // `VogelwarteSchweizSchema::optspec()` is built from the model:
        ...
        $optspec = VogelwarteSchweizSchema::optspec();
