...
// VogelwarteSchweiz SDK utility: result_basic

class VogelwarteSchweizResultBasic
{
    public static function call(VogelwarteSchweizContext $ctx): ?VogelwarteSchweizResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof VogelwarteSchweizError) ? $result->err->msg : (string)$result->err;
