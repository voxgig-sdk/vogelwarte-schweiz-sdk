...
// VogelwarteSchweiz SDK utility: graphql
//
...
class VogelwarteSchweizGraphql
{
    ...
    // equivalent.
    public static function body(VogelwarteSchweizContext $ctx): mixed
    {
    ...
    public static function errors(VogelwarteSchweizContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
