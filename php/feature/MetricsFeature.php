...
// VogelwarteSchweiz SDK metrics feature
...
class VogelwarteSchweizMetricsFeature extends VogelwarteSchweizBaseFeature
{
    ...
    private function _record(VogelwarteSchweizContext $ctx, bool $ok): void
    {
