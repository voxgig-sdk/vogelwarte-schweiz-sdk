...
// VogelwarteSchweiz SDK paging feature
...
class VogelwarteSchweizPagingFeature extends VogelwarteSchweizBaseFeature
{
    ...
    private function _is_list(VogelwarteSchweizContext $ctx): bool
    {
