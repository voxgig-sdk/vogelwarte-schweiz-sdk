...
// VogelwarteSchweiz SDK timeout feature
...
class VogelwarteSchweizTimeoutFeature extends VogelwarteSchweizBaseFeature
{
    ...
    private function _with_timeout(VogelwarteSchweizContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(VogelwarteSchweizContext $_ctx, float $ms): void
    {
        $client = $this->client;
