...
// VogelwarteSchweiz SDK proxy feature
...
class VogelwarteSchweizProxyFeature extends VogelwarteSchweizBaseFeature
{
    ...
    public function init(VogelwarteSchweizContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (VogelwarteSchweizContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
