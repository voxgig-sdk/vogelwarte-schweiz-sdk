...
// VogelwarteSchweiz SDK clienttrack feature
...
class VogelwarteSchweizClienttrackFeature extends VogelwarteSchweizBaseFeature
{
    ...
    public function PostConstruct(VogelwarteSchweizContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'VogelwarteSchweiz-SDK';
