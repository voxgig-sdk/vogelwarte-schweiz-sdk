...
// VogelwarteSchweiz SDK netsim feature
...
class VogelwarteSchweizNetsimFeature extends VogelwarteSchweizBaseFeature
{
    ...
    private function _simulate(VogelwarteSchweizContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(VogelwarteSchweizContext $ctx, array $applied): void
    {
        $client = $this->client;
