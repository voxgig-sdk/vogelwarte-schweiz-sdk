...
// VogelwarteSchweiz SDK ratelimit feature
...
class VogelwarteSchweizRatelimitFeature extends VogelwarteSchweizBaseFeature
{
    ...
    private function _acquire(VogelwarteSchweizContext $ctx): void
    {
    ...
    private function _track(VogelwarteSchweizContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
