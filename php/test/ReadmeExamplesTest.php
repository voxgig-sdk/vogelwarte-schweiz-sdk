...
// VogelwarteSchweiz SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (VogelwarteSchweizSDK::test)
...
{
    private const SDK_CLASS = 'VogelwarteSchweizSDK';
    ...
    private const SDK_BASE = 'vogelwarteschweiz_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../vogelwarteschweiz_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
