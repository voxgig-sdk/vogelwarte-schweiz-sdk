...
// VogelwarteSchweiz SDK utility type

class VogelwarteSchweizUtility
{
    ...
    public static function copy(VogelwarteSchweizUtility $src): VogelwarteSchweizUtility
    {
        $u = new VogelwarteSchweizUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
