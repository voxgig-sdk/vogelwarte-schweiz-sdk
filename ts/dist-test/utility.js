...
function envOverride(m) {
    if ('TRUE' === process.env.VOGELWARTE_SCHWEIZ_TEST_LIVE ||
        'TRUE' === process.env.VOGELWARTE_SCHWEIZ_TEST_OVERRIDE) {
    ...
    m.VOGELWARTE_SCHWEIZ_TEST_EXPLAIN = process.env.VOGELWARTE_SCHWEIZ_TEST_EXPLAIN || m.VOGELWARTE_SCHWEIZ_TEST_EXPLAIN;
    return m;
}
