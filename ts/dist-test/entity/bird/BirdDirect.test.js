...
(0, node_test_1.describe)('BirdDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.VogelwarteSchweizSDK({
    ...
    (0, node_test_1.test)('direct-load-bird', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-bird', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-bird', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-bird', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.VOGELWARTE_SCHWEIZ_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.VogelwarteSchweizSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['VOGELWARTE_SCHWEIZ_TEST_BIRD_ENTID'];
    ...
    const client = new __1.VogelwarteSchweizSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=BirdDirect.test.js.map