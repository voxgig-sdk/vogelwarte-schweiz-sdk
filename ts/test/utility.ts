...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.VOGELWARTESCHWEIZ_TEST_LIVE ||
    'TRUE' === process.env.VOGELWARTESCHWEIZ_TEST_OVERRIDE
  ) {
  ...
  m.VOGELWARTESCHWEIZ_TEST_EXPLAIN = process.env.VOGELWARTESCHWEIZ_TEST_EXPLAIN || m.VOGELWARTESCHWEIZ_TEST_EXPLAIN
