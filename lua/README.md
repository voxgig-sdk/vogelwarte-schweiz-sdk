# VogelwarteSchweiz Lua SDK

The Lua SDK for the VogelwarteSchweiz API. Provides an entity-oriented interface using Lua conventions.
...
local result, err = client:VogelwarteSchweiz(nil):load(
  { id = "test01" }, nil
)
...
```
lua/
├── vogelwarte-schweiz_sdk.lua    -- Main SDK module
...
The main module (`vogelwarte-schweiz_sdk`) exports the SDK constructor
