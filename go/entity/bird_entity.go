...
type BirdEntity struct {
	name    string
	client  *core.VogelwarteSchweizSDK
...
func NewBirdEntity(client *core.VogelwarteSchweizSDK, entopts map[string]any) *BirdEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
