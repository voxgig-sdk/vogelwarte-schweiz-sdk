...
type VogelwarteSchweizSDK struct {
	Mode     string
...
func (sdk *VogelwarteSchweizSDK) OptionsMap() map[string]any {
...
func (sdk *VogelwarteSchweizSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *VogelwarteSchweizSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *VogelwarteSchweizSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *VogelwarteSchweizSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *VogelwarteSchweizSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *VogelwarteSchweizSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("VogelwarteSchweizSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *VogelwarteSchweizSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *VogelwarteSchweizSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("VogelwarteSchweizSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *VogelwarteSchweizSDK {
	...
	sdk := NewVogelwarteSchweizSDK(sdkopts)
	sdk.Mode = "test"
