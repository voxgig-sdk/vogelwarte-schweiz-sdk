...
// instead of `sdk.NewVogelwarteSchweizSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *VogelwarteSchweizSDK  { return NewVogelwarteSchweizSDK(nil) }
func Test() *VogelwarteSchweizSDK { return TestSDK(nil, nil) }
