...
const testSeed = `map[string]any{"entity": map[string]any{"bird": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "species": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
