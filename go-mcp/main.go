// Command VogelwarteSchweiz-mcp is an MCP server exposing the VogelwarteSchweiz
// SDK as MCP tools.
//
// Two tools are registered:
//
//	VogelwarteSchweiz_list  — list records of an entity
//	VogelwarteSchweiz_load  — load a single record of an entity
//
