...
type Args struct {
	Entity string         `json:"entity" jsonschema:"bird | species"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.VogelwarteSchweizSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "vogelwarte-schweiz_list",
		Description: "List records from VogelwarteSchweiz. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "vogelwarte-schweiz_load",
		Description: "Load a single record from VogelwarteSchweiz. " +
...
func runOp(client *sdk.VogelwarteSchweizSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.VogelwarteSchweizSDK, name string) (sdk.VogelwarteSchweizEntity, error) {
