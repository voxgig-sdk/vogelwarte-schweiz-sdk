...
Learn more about Vogelwarte Schweiz at [vogelwarte.ch](https://vogelwarte.ch).
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/vogelwarte-schweiz-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/vogelwarte-schweiz-sdk/tags) |
| Python | `voxgig-sdk-vogelwarte-schweiz` | publish pending — [install from git tag](https://github.com/voxgig-sdk/vogelwarte-schweiz-sdk/tags) |
| PHP | `voxgig-sdk/vogelwarte-schweiz` | publish pending — [install from git tag](https://github.com/voxgig-sdk/vogelwarte-schweiz-sdk/tags) |
| Golang | `github.com/voxgig-sdk/vogelwarte-schweiz-sdk/go` | `go get github.com/voxgig-sdk/vogelwarte-schweiz-sdk/go@latest` |
| Ruby | `voxgig-sdk-vogelwarte-schweiz` | publish pending — [install from git tag](https://github.com/voxgig-sdk/vogelwarte-schweiz-sdk/tags) |
| Lua | `voxgig-sdk-vogelwarte-schweiz` | publish pending — [install from git tag](https://github.com/voxgig-sdk/vogelwarte-schweiz-sdk/tags) |
| Go CLI | `github.com/voxgig-sdk/vogelwarte-schweiz-sdk/go-cli` | `go install github.com/voxgig-sdk/vogelwarte-schweiz-sdk/go-cli/cmd/vogelwarte-schweiz@latest` |
| Go MCP server | `github.com/voxgig-sdk/vogelwarte-schweiz-sdk/go-mcp` | `go get github.com/voxgig-sdk/vogelwarte-schweiz-sdk/go-mcp@latest` |
...
$birds = $client->Bird()->list();
print_r(array_map(fn($item) => $item->data_get(), $birds));
