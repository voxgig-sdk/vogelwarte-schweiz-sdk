...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/vogelwarte-schweiz` | `npm install @voxgig-sdk/vogelwarte-schweiz` |
| Python | `voxgig-sdk-vogelwarte-schweiz` | `pip install voxgig-sdk-vogelwarte-schweiz` |
| PHP | `voxgig-sdk/vogelwarte-schweiz` | `composer require voxgig-sdk/vogelwarte-schweiz` |
| Golang | `github.com/voxgig-sdk/vogelwarte-schweiz-sdk/go` | `go get github.com/voxgig-sdk/vogelwarte-schweiz-sdk/go` |
| Ruby | `voxgig-sdk-vogelwarte-schweiz` | `gem install voxgig-sdk-vogelwarte-schweiz` |
| Lua | `voxgig-sdk-vogelwarte-schweiz` | `luarocks install voxgig-sdk-vogelwarte-schweiz` |
