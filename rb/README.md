...
The Ruby SDK for the VogelwarteSchweiz API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.VogelwarteSchweiz(nil).load(
  { "id" => "test01" }, nil
)
