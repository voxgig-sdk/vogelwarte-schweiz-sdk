...
#      offline in seeded test mode (VogelwarteSchweizSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "VogelwarteSchweiz_sdk.rb")
  SDK_CLASS = "VogelwarteSchweizSDK"
  ...
  SDK_BASE = "VogelwarteSchweiz_sdk"
