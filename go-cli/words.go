...
func registerSDKWords(r *eng.Registry, client *sdk.VogelwarteSchweizSDK) {
...
func runOp(client *sdk.VogelwarteSchweizSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
