...
AQL-driven CLI and REPL for the VogelwarteSchweiz SDK. Positional arguments are
...
```sh
go build -o vogelwarte-schweiz-cli ./...
```
...
./vogelwarte-schweiz-cli load 1 bird
./vogelwarte-schweiz-cli load '{id:1}' bird
