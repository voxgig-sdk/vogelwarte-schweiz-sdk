...
// VogelwarteSchweiz SDK cache feature
...
class VogelwarteSchweizCacheFeature extends VogelwarteSchweizBaseFeature
{
    ...
    private function _through(VogelwarteSchweizContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
