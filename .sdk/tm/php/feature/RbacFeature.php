...
// VogelwarteSchweiz SDK rbac feature
...
class VogelwarteSchweizRbacFeature extends VogelwarteSchweizBaseFeature
{
    ...
    private function _required(VogelwarteSchweizContext $ctx): ?string
    {
    ...
    private function _reject(VogelwarteSchweizContext $ctx, string $required): void
    {
    ...
    private function _track(VogelwarteSchweizContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
