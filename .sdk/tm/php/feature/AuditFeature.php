...
// VogelwarteSchweiz SDK audit feature
...
class VogelwarteSchweizAuditFeature extends VogelwarteSchweizBaseFeature
{
    ...
    private function _emit(VogelwarteSchweizContext $ctx, string $outcome): void
    {
