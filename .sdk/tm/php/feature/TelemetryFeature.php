...
// VogelwarteSchweiz SDK telemetry feature
...
class VogelwarteSchweizTelemetryFeature extends VogelwarteSchweizBaseFeature
{
    ...
    private function _close(VogelwarteSchweizContext $ctx, bool $ok): void
    {
