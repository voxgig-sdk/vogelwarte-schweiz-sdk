...
// VogelwarteSchweiz SDK streaming feature
...
class VogelwarteSchweizStreamingFeature extends VogelwarteSchweizBaseFeature
{
    ...
    private function _iterate(VogelwarteSchweizResult $result): \Generator
    {
    ...
    private function _streamable(VogelwarteSchweizContext $ctx): bool
    {
