...
// VogelwarteSchweiz SDK idempotency feature
...
class VogelwarteSchweizIdempotencyFeature extends VogelwarteSchweizBaseFeature
{
    ...
    private function _mutating(VogelwarteSchweizContext $ctx): bool
    {
