...
// VogelwarteSchweiz SDK utility: fetcher

class VogelwarteSchweizFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; VogelwarteSchweizSDK/1.0)';
    ...
    public static function call(VogelwarteSchweizContext $ctx, string $fullurl, array $fetchdef): array
    {
