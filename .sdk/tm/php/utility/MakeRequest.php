...
// VogelwarteSchweiz SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class VogelwarteSchweizMakeRequest
{
    public static function call(VogelwarteSchweizContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new VogelwarteSchweizResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new VogelwarteSchweizResponse($fetched);
        } else {
