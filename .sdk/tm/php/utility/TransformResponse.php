...
// VogelwarteSchweiz SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class VogelwarteSchweizTransformResponse
{
    public static function call(VogelwarteSchweizContext $ctx): mixed
    {
        ...
        $transform = VogelwarteSchweizHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
