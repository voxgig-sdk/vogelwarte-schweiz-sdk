...
|---|---|---|
| `ts/` | @voxgig-sdk/vogelwarte-schweiz-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/vogelwarte-schweiz-sdk \
      --repository voxgig-sdk/vogelwarte-schweiz-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/vogelwarte-schweiz-sdk` shows it, and
`npm trust revoke @voxgig-sdk/vogelwarte-schweiz-sdk --id=<id>` removes it.
