# VogelwarteSchweiz SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions VogelwarteSchweizSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both VogelwarteSchweizSDK(...) and VogelwarteSchweizSDK.test(...) become
#      VogelwarteSchweizSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "vogelwarteschweiz_sdk"
_SDK_CLASS = "VogelwarteSchweizSDK"
