# VogelwarteSchweiz SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from vogelwarteschweiz_sdk import VogelwarteSchweizSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"VogelwarteSchweizSDK": VogelwarteSchweizSDK, "os": os}
        try:
