...
from vogelwarteschweiz_sdk.core.helpers import get_ctx_prop, to_map
...
class VogelwarteSchweizContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = VogelwarteSchweizControl()
        ...
        if isinstance(sp, VogelwarteSchweizSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, VogelwarteSchweizResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, VogelwarteSchweizResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return VogelwarteSchweizOperation({})
    ...
    def make_error(self, code, msg):
        return VogelwarteSchweizError(code, msg, self)
