...
from vogelwarteschweiz_sdk.utility import register

# Load features
from vogelwarteschweiz_sdk.feature.base_feature import VogelwarteSchweizBaseFeature
from vogelwarteschweiz_sdk.features import _has_feature, _make_feature
...
class VogelwarteSchweizSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = VogelwarteSchweizUtility()
        self._utility = utility

        from vogelwarteschweiz_sdk.config import shared_config
    ...
    def get_utility(self):
        return VogelwarteSchweizUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("VogelwarteSchweizSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Bird(self, data=None) -> "BirdEntity":
        ...
        from vogelwarteschweiz_sdk.entity.bird_entity import BirdEntity
    ...
    def Species(self, data=None) -> "SpeciesEntity":
        ...
        from vogelwarteschweiz_sdk.entity.species_entity import SpeciesEntity
        return SpeciesEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "VogelwarteSchweizSDK":
        if sdkopts is None:
            sdkopts = {}
