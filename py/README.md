...
The Python SDK for the VogelwarteSchweiz API. Provides an entity-oriented interface following Pythonic conventions.
...
result, err = client.VogelwarteSchweiz(None).load(
    {"id": "test01"}, None
)
