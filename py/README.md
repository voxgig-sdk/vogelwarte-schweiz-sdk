# VogelwarteSchweiz Python SDK



The Python SDK for the VogelwarteSchweiz API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/vogelwarte-schweiz-sdk/releases)) or
...
```
py/
├── vogelwarteschweiz_sdk.py         -- Main SDK module
